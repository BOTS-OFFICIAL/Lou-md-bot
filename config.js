...
module.exports = {
  ...
  SUDO: process.env.SUDO || '+263789432940',
  WORK_TYPE: process.env.WORK-TYPE ||'public',
  MODE: process.env.MODE ||'public',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  OWNER_NAME: process.env.OWNER_NAME || 'MAGICAL KX ', // put your name here eg Magical KX . if you leave it it will give Owner Name as Magical KX
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'lou-md-bot-bot', //Don't change here
