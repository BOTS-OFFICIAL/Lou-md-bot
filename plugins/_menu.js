...
bot.addCommand(
  ...
  async (message, match, ctx) => {
    ...
    let CMD_HELP = `╭═══════════════⊷
┃ HELLO @${message.pushName} I'm lou-md-bot-bot 
┃ Created by  Kenton X  
┃And owned by @$(s.OWNER_NAME)
┃This is my Menu
┃
┃PLEASE GIVE A STAR TO MY REPO
┃
╰═══════════════⊷
╭═══════════════⊷
┃lou-md-bot-BOT
...
┃❃┃→ Made with love by Magical KX
┃❃┃→ Type Ping to test bot speed\`\`\`\n`
