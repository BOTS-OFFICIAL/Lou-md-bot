...
A simple WhatsApp User bot CREATED BY MAGICAL KX

## How to deploy this wonderful bot
...
3. **Fork Repository:**
   - [FORK](https://github.com/BOTS-OFFICIAL/lou-md-bot/fork) this repository.
...
5. **Clone Repository and Install Packages:**
   ```sh
   git clone https://github.com/BOTS-OFFICIAL/lou-md-bot botName
   cd botName
   yarn install
   ```
